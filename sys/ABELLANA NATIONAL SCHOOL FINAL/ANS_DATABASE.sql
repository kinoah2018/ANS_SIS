...
AS 
BEGIN
INSERT INTO TBL_USERS VALUES(@USER_LASTNAME,@USER_FIRSTNAME,@USER_MIDDLENAME,@USER_USERNAME,@USER_PASSWORD,@USER_CONTACTNO,'1',GETDATE(),@USER_CREATOR,@USER_TYPE,@USER_IMAGE,@SECURITYQUESTION,@ANSWER);
END
...
SET USER_LASTNAME = @USER_LASTNAME, USER_FIRSTNAME = @USER_FIRSTNAME, USER_MIDDLENAME = @USER_MIDDLENAME,
	USER_USERNAME = @USER_USERNAME, USER_CONTACT = @USER_CONTACT, ISACTIVE = @ISACTIVE  ,USER_IMAGE = @USER_IMAGE
...
BEGIN
SELECT * FROM TBL_USERS
WHERE USER_USERNAME = @USER_USERNAME AND SECURITYQUESTION = @SECURITYQUESTION AND ANSWER = @ANSWER
END
