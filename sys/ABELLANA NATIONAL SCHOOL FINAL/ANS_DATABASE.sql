...
AS
BEGIN
SELECT        dbo.TBL_STUDENT.ST_FIRSTNAME + ' ' + dbo.TBL_STUDENT.ST_MIDDLENAME + ' ' + dbo.TBL_STUDENT.ST_LASTNAME AS FULLNAME, dbo.TBL_BMICOMP.BMI_HWRESULT AS [BMI RESULT], 
                         dbo.TBL_BMICOMP.BMI_BPRESULT AS [BLOODPRESSURE RESULT]
...
CREATE PROCEDURE SP_SECVIEW
AS
BEGIN
SELECT        SEC_ID, SEC_NAME, SEC_CAPACITY
...
(@B_BOOKNAME,@B_BOOKDESC,@BOOK_YEARLEVEL)
END
...
BEGIN
UPDATE TBL_BOOKS
SET B_BOOKNAME=@B_BOOKNAME,B_BOOKDESC=@B_BOOKDESC,BOOK_YEARLEVEL=@BOOK_YEARLEVEL
WHERE B_ID=@B_ID
END
...
AS
BEGIN
SELECT        B_ID, B_BOOKNAME, B_BOOKDESC, BOOK_YEARLEVEL
FROM            dbo.TBL_BOOKS
END
