...
ST_BLOODPRESSURE VARCHAR(50) NOT NULL,
...
(@NAME,@P_CONTACT,@P_OCCUPATION,@P_TYPE)
INSERT INTO TBL_STUDENT VALUES
(@ST_FIRSTNAME,@ST_MIDDLENAME,@ST_LASTNAME,@ST_YEARLEVEL,@ST_SCHOOLYEAR,@ST_BIRTHDATE,@ST_AGE,@ST_BIRTHPLACE,@ST_ADDRESS,@ST_GENDER,@ST_CONTACTNUMBER,1,@ST_HEIGHT,@ST_WEIGHT,@ST_BLOODPRESSURE,@@IDENTITY)
END
...
BEGIN
UPDATE TBL_PARENT
SET     P_NAME=@P_NAME,P_CONTACT=@P_CONTACT,P_OCCUPATION=@P_OCCUPATION,P_TYPE=@P_TYPE
UPDATE TBL_STUDENT
SET	   ST_FIRSTNAME=@ST_FIRSTNAME,ST_MIDDLENAME=@ST_MIDDLENAME,ST_LASTNAME=@ST_LASTNAME,ST_YEARLEVEL=@ST_YEARLEVEL,ST_SCHOOLYEAR=@ST_SCHOOLYEAR,ST_AGE=@ST_AGE,ST_BIRTHDATE=@ST_BIRTHDATE,ST_ADDRESS=@ST_ADDRESS,
	   ST_GENDER=@ST_GENDER,ST_CONTACTNUMBER=@ST_CONTACTNUMBER,ISACTIVE=@ISACTIVE,ST_HEIGHT=@ST_HEIGHT,ST_WEIGHT=@ST_WEIGHT,ST_BLOODPRESSURE=@ST_BLOODPRESSURE
WHERE  ST_ID = @ST_ID
END
