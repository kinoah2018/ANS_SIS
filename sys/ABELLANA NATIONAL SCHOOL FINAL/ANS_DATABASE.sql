...
(@SEC_NAME,@SEC_CAPACITY,@SEC_ADVISORY)
END
...
AS
BEGIN
SELECT        dbo.TBL_SECTION.SEC_ID, dbo.TBL_SECTION.SEC_NAME, dbo.TBL_SECTION.SEC_CAPACITY, dbo.TBL_TEACHER.T_ID, 
                         dbo.TBL_TEACHER.T_FIRSTNAME + ' ' + dbo.TBL_TEACHER.T_MIDDLENAME + ' ' + dbo.TBL_TEACHER.T_LASTNAME AS [TEACHER NAME]
...
(@TEACHERNAME,@SEC_ID,@THSUBJECT,@TIME_ID)
END

ALTER PROCEDURE SP_THSCHEDVIEW
AS
SELECT        dbo.TBL_TEACHERSCHEDULE.TSCHED_ID, dbo.TBL_TEACHERSCHEDULE.TEACHERNAME, dbo.TBL_TEACHERSCHEDULE.THSUBJECT, dbo.TBL_SECTION.SEC_ID, dbo.TBL_SECTION.SEC_NAME, 
                         dbo.TBL_SCHEDULETIME.TIME_ID, dbo.TBL_SCHEDULETIME.TIME_START + '-' + dbo.TBL_SCHEDULETIME.TIME_END AS SCHEDULE
FROM            dbo.TBL_TEACHERSCHEDULE INNER JOIN
                         dbo.TBL_SECTION ON dbo.TBL_TEACHERSCHEDULE.SEC_ID = dbo.TBL_SECTION.SEC_ID INNER JOIN
                         dbo.TBL_SCHEDULETIME ON dbo.TBL_TEACHERSCHEDULE.TIME_ID = dbo.TBL_SCHEDULETIME.TIME_ID
