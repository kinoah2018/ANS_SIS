...
(@ST_CURRENTID,@ST_FIRSTNAME,@ST_MIDDLENAME,@ST_LASTNAME,@ST_YEARLEVEL,@ST_SCHOOLYEAR,@ST_BIRTHDATE,@ST_AGE,@ST_BIRTHPLACE,@ST_ADDRESS,@ST_GENDER,1,@ST_HEIGHT,@ST_WEIGHT,@ST_BPSYSTOLIC,@ST_BPDIASTOLIC,@@IDENTITY)
END
...
SET	   ST_FIRSTNAME=@ST_FIRSTNAME,ST_MIDDLENAME=@ST_MIDDLENAME,ST_LASTNAME=@ST_LASTNAME,ST_YEARLEVEL=@ST_YEARLEVEL,ST_SCHOOLYEAR=@ST_SCHOOLYEAR,ST_BIRTHDATE=@ST_BIRTHDATE,ST_AGE=@ST_AGE,ST_BIRTHPLACE=@ST_BIRTHPLACE,ST_ADDRESS=@ST_ADDRESS,
	   ST_GENDER=@ST_GENDER,ISACTIVE=@ISACTIVE,ST_HEIGHT=@ST_HEIGHT,ST_WEIGHT=@ST_WEIGHT,ST_BPSYSTOLIC = @ST_BPSYSTOLIC , ST_BPDIASTOLIC=@ST_BPDIASTOLIC
WHERE  ST_ID = @ST_ID
END
